...
<body>
  ...
  <header class="clearfix">
    ...
    <ul class="account-apps float-right flex-center-evenly">
      
      <li class="account float-left">
        M
      </li>

      <li class="apps float-left">
  ...
  <main>
    <div class="container">
      <?php foreach ($faqs as $faq) { ?> <!-- ciclo per tirare fuori ogni singolo faq -->
        <h2 class ="question">
          <?php echo $faq['question']; ?>
        </h2>

        <?php foreach ($faq['answer'] as  $paragraph) { ?> <!-- ciclo per stampare le risposte divise in paragrafi a schermo -->
          <p class="answer">
            <?php echo $paragraph; ?>
          </p>         
